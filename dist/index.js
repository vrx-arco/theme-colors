...
function colorPalette(originColor, i, format) {
  ...
  const retColor = i === 6 ? color : new TinyColor({
...
function colorPaletteDark(originColor, i, format) {
  const lightColor = new TinyColor(colorPalette(originColor, 10 - i + 1)).toHsv();
  const originBaseColor = new TinyColor(originColor).toHsv();
